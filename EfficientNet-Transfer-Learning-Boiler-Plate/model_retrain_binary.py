...
model_output_name = "retrain_b0_on_guns_no_guns_200_ephocs_binary_upd.h5"
...
x = Dense(1, activation='sigmoid')(model.get_layer('top_dropout').output)
...
# new_model.compile(loss='sparse_binary_crossentropy', optimizer='adam')
